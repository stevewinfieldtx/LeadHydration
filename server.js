      ...
      try {
        ...
        if (col && (col.stats?.atomCount || 0) > 20) {
          ...
          try {
            ...
            const messages = [
              { role: 'system', content: `Convert this solution intelligence into the exact JSON format below. Use ONLY the data provided — do not invent information.\n\nCRITICAL FOR targetMarket: Describe ONLY who SHOULD buy this product — positive ideal customer profile (company size, industry, typical situation, pain points that make them a good fit). DO NOT include exclusion criteria, disqualification signals, or descriptions of who should NOT buy.\n\n{\n  "name": "Product Name",\n  "type": "Type of solution",\n  "description": "What the solution does",\n  "capabilities": ["cap1", "cap2", "cap3", "cap4", "cap5"],\n  "targetMarket": "Positive ICP only: company size, industries, and situations that make them ideal buyers",\n  "keyBenefits": ["benefit1", "benefit2", "benefit3"],\n  "differentiators": ["diff1", "diff2"],\n  "proofPoints": ["proof1", "proof2"],\n  "painPointsSolved": ["pain1", "pain2", "pain3"],\n  "confidence": "high",\n  "source": "tde"\n}\n\nReturn ONLY valid JSON.` },
